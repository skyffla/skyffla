...
- Keep tracked reference docs under `docs/`. Use `*.local.md` only for local planning or scratch documents; those files should stay gitignored and out of shipped docs.
